...
public class CustomeResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	 ...
	 * ResponseEntity<Object> handleUserNotFoundException(Exception ex, WebRequest
	 * request) throws Exception { ErrorDetails errorDetails = new
	 * ErrorDetails(LocalDate.now(),ex.getMessage(),request.getDescription(false));
